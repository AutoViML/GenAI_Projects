...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-q", "--question",
        type=str,
        required=True, # Require at least one question
        help="The user question to process."
        # TODO: Add option to read questions from a file?
    )
    ...
    try:
         ...
         if args.judge:
             ...
             judge_model_name = load_text_file(judge_model_name_path).strip()
    ...
    # --- Define Questions and Model Configs ---
    # For now, use the single question from args. Can be extended to read from file.
    questions_to_process = [args.question]
